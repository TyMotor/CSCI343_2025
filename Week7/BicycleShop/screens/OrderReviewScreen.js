      ...
      <ScrollView style={styles.scrollContainer}>
        <View style={styles.subTitleContainer}>
          <Text style={styles.subTitle}>
            Your order has been placed! View your order details below.
          </Text>
        </View>
        ...
        <View style={styles.servicesContainer}>
          ...
          <Text style={styles.service}>Service Types:</Text>
          ...
          <View style={styles.subTitleContainer}>
            ...
            <Text style={styles.subTitle}>
              Subtotal: ${(props.price * 0.06).toFixed(2)}
            </Text>
            <Text style={styles.subTitle}>
              Subtotal: ${(props.price * 1.06).toFixed(2)}
            </Text>
          </View>
        </View>
